        ...
        <table>
            ...
            <tbody id="members-tbody">
                <tr><form id="memberAdd">
                        ...
                        <td><input type="text" name="firstname" placeholder="First Name" style="margin-right: 10px" required><input type="text" name="lastname" placeholder="Last Name" required></td>
        ...
        <table>
            ...
            <tbody id="events-tbody">
                <tr><form id="eventAdd">
                        ...
                        <td><textarea name="description" placeholder="Description of Event"  style="width: 100%" required></textarea></td>
                        <td>
                            <input type="text" name="locationName" placeholder="Location Name" style="margin-bottom: 10px" required>
                            <input type="number" name="latitude" placeholder="46.8207" step="any" style="margin-bottom: 10px" required>
